 ...
 * Application Server ejbc utility be run. <p>
 *
...
public class IPlanetEjbc
{
     ...
     * the ejbc compiler.
     *
     * @author Greg Nelson <a href="mailto:greg@netscape.com">greg@netscape.com
     *      </a>
     */
    ...
    {// EJB's implementation class
         ...
         * (home, remote, and implementation classes), the method returns <code>false</code>
